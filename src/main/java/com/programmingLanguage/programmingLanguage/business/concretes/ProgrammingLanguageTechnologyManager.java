...
public class ProgrammingLanguageTechnologyManager implements ProgrammingLanguageTechnologyService{
	...
	public CreateProgrammingLanguageTechnologyRequest add(CreateProgrammingLanguageTechnologyRequest createProgrammingLanguageTechnologyRequest) {
		this.programmingLanguageTechnologyRules.checkIfProgrammingLanguageNameTechnologyExists(createProgrammingLanguageTechnologyRequest.getName());
		...
		this.programmingLanguageTechnologyRules.checkIfProgrammingLanguageNameTechnologyIgnoreCase(createProgrammingLanguageTechnologyRequest.getName());
	...
	public UpdateProgrammingLanguageTechnologyRequest update(int id,UpdateProgrammingLanguageTechnologyRequest updateProgrammingLanguageTechnologyRequest) {
		this.programmingLanguageTechnologyRules.checkIfProgrammingLanguageNameTechnologyExists(updateProgrammingLanguageTechnologyRequest.getName());
		...
		this.programmingLanguageTechnologyRules.checkIfProgrammingLanguageTechnologyBlankAndNull(updateProgrammingLanguageTechnologyRequest);
		this.programmingLanguageTechnologyRules.checkIfProgrammingLanguageNameTechnologyIgnoreCase(updateProgrammingLanguageTechnologyRequest.getName());
